...
public partial class BlueCrownContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AutoPrescription>(entity =>
        {
            ...
            entity.HasIndex(e => e.DiseaseName, "UQ__auto_pre__81B56A50EF839387")
                .IsUnique();
            ...
            entity.Property(e => e.RecommendedProductId)
                .HasColumnName("recommended_product_id");

            entity.HasOne(d => d.RecommendedProduct)
                .WithMany(p => p.AutoPrescriptions)
        ...
        modelBuilder.Entity<ChatSession>(entity =>
        {
            ...
            entity.Property(e => e.AiSymptomLogId)
                .HasColumnName("ai_symptom_log_id");
        ...
        modelBuilder.Entity<DoctorProfile>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "UQ__doctor_p__B9BE370E33BA793F")
                .IsUnique();

            entity.HasIndex(e => e.LicenseNumber, "UQ__doctor_p__D482A003F3DF7F4F")
                .IsUnique();
        ...
        modelBuilder.Entity<DrugAlternative>(entity =>
        {
            ...
            entity.Property(e => e.AlternativeProductId)
            ...
            entity.HasOne(d => d.AlternativeProduct)
                .WithMany(p => p.DrugAlternativeAlternativeProducts)
                .HasForeignKey(d => d.AlternativeProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DrugAlternative_Alternative");

            entity.HasOne(d => d.Product)
                .WithMany(p => p.DrugAlternativeProducts)
        ...
        modelBuilder.Entity<InventoryReceipt>(entity =>
        {
            ...
            entity.HasOne(d => d.ApprovedByNavigation)
                .WithMany(p => p.InventoryReceiptApprovedByNavigations)
                .HasForeignKey(d => d.ApprovedBy)
                .HasConstraintName("FK__inventory__appro__2180FB33");

            entity.HasOne(d => d.CreatedByNavigation)
                .WithMany(p => p.InventoryReceiptCreatedByNavigations)
        ...
        modelBuilder.Entity<MedicalRecord>(entity =>
        {
            ...
            entity.HasIndex(e => e.AppointmentId, "UX_medical_records_appointment_id")
                .IsUnique();
        ...
        modelBuilder.Entity<MetricType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Code, "UQ__metric_t__357D4CF976A58189")
                .IsUnique();
        ...
        modelBuilder.Entity<PatientProfile>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "UQ__patient___B9BE370EF2437BBC")
                .IsUnique();
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.HasIndex(e => e.TransactionRef, "UQ__payments__89389771EF364AD6")
                .IsUnique();
        ...
        modelBuilder.Entity<Prescription>(entity =>
        {
            ...
            entity.HasIndex(e => e.AppointmentId, "UX_prescriptions_appointment_id")
                .IsUnique();
        ...
        modelBuilder.Entity<PrescriptionItem>(entity =>
        {
            ...
            entity.Property(e => e.FrequencyPerDay)
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.PrescriptionRequired)
        ...
        modelBuilder.Entity<ReceiptDetail>(entity =>
        {
            ...
            entity.Property(e => e.QuantityImported)
                .HasColumnName("quantity_imported");
        ...
        modelBuilder.Entity<SymptomLog>(entity =>
        {
            ...
            entity.Property(e => e.AiAdvice)
                .HasColumnName("ai_advice");
            ...
            entity.Property(e => e.SymptomsDescription)
                .HasColumnName("symptoms_description");

            entity.HasOne(d => d.Patient)
                .WithMany(p => p.SymptomLogs)
                .HasForeignKey(d => d.PatientId)
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__users__AB6E6164FD5C4AEA")
                .IsUnique();

            entity.HasIndex(e => e.Phone, "UQ__users__B43B145F445F1DE5")
                .IsUnique();
