...
CREATE TABLE health_goals (
    ...
    created_by_role NVARCHAR(20) NOT NULL CHECK (created_by_role IN ('patient', 'doctor'))
);
...
CREATE TABLE products (
    ...
    medication_id UNIQUEIDENTIFIER NULL REFERENCES medications(id) ON DELETE SET NULL
);
